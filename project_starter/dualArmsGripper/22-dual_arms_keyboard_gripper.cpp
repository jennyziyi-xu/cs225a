...
namespace {
const string world_file = string(DUALARMSGRIPPER_FOLDER) + "/world.urdf";
// const string world_file = "/home/harrison/stanford/OpenSai/cs225a/project_starter/dualArmsGripper/world.urdf";
const string robot_file = string(CS225A_URDF_FOLDER) + "/panda/panda_arm_hand.urdf";
// const string robot_file = "/home/harrison/stanford/OpenSai/cs225a/project_starter/dualArmsGripper/panda/panda_arm_hand.urdf";
